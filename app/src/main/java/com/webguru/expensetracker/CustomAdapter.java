...
//            holder.income.setText("");
            holder.expense.setText("₹ " + u.getExpense());
            holder.expense.setTextColor(Color.argb(255, 0, 255,0));
            holder.date.setText(u.getDate());
        }
        else if(u.getExpense() == 0){
//            User u = userList.get(position);
            holder.eid.setText("" + u.getId());
            holder.name.setText(u.getName());
            holder.expense.setText("₹ -" + u.getIncome());
            holder.expense.setTextColor(Color.argb(255, 255, 0,0));
            holder.date.setText(u.getDate());
        }
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            switch (menuItem.getItemId()) {
                case 0:
                    ...
                    User u = userList.get(position);
                    if(u.getIncome() == 0){
                        Intent modifyRecord = new Intent(context, CreditPage.class);
                      ...
                      Intent modifyRecord = new Intent(context, DebitPage.class);
                        modifyRecord.putExtra("rec_id", rec_id);
                        context.startActivity(modifyRecord);
                        return true;
                    }
